									...
									<div class="dataTables_wrapper">
										<div class="dataTables_scroll">
												...
												<tbody>
													...
													<!-- start 人员在位情况 -->
													<tr class="odd">
															<td class="span3" style="text-align:center;background-color: #e8e8e8;" rowspan="16"><h4>全团值班情况</h4></td>
															<td style="text-align: center;background-color: #f2f2f2;" rowspan="2"><h4>全团</h4></td>
													...
													<tr class="odd">
														<td style="text-align: center;background-color: #f2f2f2;" rowspan="2"><h4>一营</h4></td>
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																<tr class="odd">
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>值班首长</h4></td>
													...
													<tr class="odd">
														<td style="text-align: center;background-color: #f2f2f2;" rowspan="2"><h4>二营</h4></td>
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																<tr class="odd">
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>值班首长</h4></td>
													...
													<tr class="odd">
														<td style="text-align: center;background-color: #f2f2f2;" rowspan="2"><h4>三营</h4></td>
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																<tr class="odd">
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>值班首长</h4></td>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_3" id="remark_3" rows="3" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp3.remark_t}--</textarea>
														</td>
													</tr>
													
													<tr class="odd">
														<td style="text-align: center;background-color: #f2f2f2;" rowspan="2"><h4>四营</h4></td>
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																<tr class="odd">
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>值班首长</h4></td>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_4" id="remark_4" rows="3" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp4.remark_t}--</textarea>
														</td>
													</tr>
													
													<tr class="odd">
														<td style="text-align: center;background-color: #f2f2f2;" rowspan="2"><h4>五营</h4></td>
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																<tr class="odd">
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>值班首长</h4></td>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_5" id="remark_5" rows="3" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp5.remark_t}--</textarea>
														</td>
													</tr>
													<tr class="odd">
														<td style="text-align: center;background-color: #f2f2f2;" rowspan="2"><h4>警勤连</h4></td>
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																<tr class="odd">
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>值班首长</h4></td>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_jql" id="remark_jql" rows="3" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp6.remark_t}--</textarea>
														</td>
													</tr>
													<tr class="odd">
														<td style="text-align: center;background-color: #f2f2f2;" rowspan="2"><h4>教导队</h4></td>
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																<tr class="odd">
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>值班首长</h4></td>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_jdd" id="remark_jdd" rows="3" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp7.remark_t}--</textarea>
														</td>
													</tr>
													<!-- end 人员在位情况 -->
