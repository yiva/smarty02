					...
					<div class="span12">
						<div class="box box-bordered box-color">
							<div class="box-title">
								...
								<div class="offset2 span6" style=""><h3><strong>值班首长:</strong><span id="dutyhead">--{$workTemp.dutyhead}--</span>&nbsp;&nbsp;&nbsp;&nbsp;<strong>值班员:</strong><span id="dutyer">--{$workTemp.dutyer}--</span></h3></div>
							</div>
							<div class="box-content nopadding">
								<form action="" method="post" class='form-horizontal form-bordered form-vertical'>
									<div class="control-group">
									...
									<div class="dataTables_wrapper">
										<div class="dataTables_scroll">
												...
												<tbody>
													<!-- Begin 工作情况及营领导位置 -->
													<tr>
														<td class="span3" style="text-align:center;background-color: #dedede;"><h4>值班首长</h4></td>
														<td colspan="2">
															<div class="control-group" style="border:none;">
																<div class="controls">
																	<h4>--{$workTemp.dutyhead}--</h4>
																</div>
															</div>
														</td>
													</tr>
													<tr>
														<td style="text-align:center;background-color: #e8e8e8;"><h4>值班员</h4></td>
														<td colspan="2">
															<div class="control-group" style="border:none;">
																<div class="controls">
																	<h4>--{$workTemp.dutyer}--</h4>
																</div>
															</div>
														</td>
													</tr>
													...
													<tr class="odd">
														...
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																<tr class="odd">
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>值班首长</h4></td>
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>值班员</h4></td>
																	<td style="text-align: center;background-color: #f2f2f2;"><h4>应到/实到</h4></td>
																</tr>
																<tr class="odd">
																	<td style="text-align: center;">
																		<div>
                                                                      --{$workTemp0.dutyhead_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																	...
																	<td style="text-align: center;">
																		<div>
                                                                     --{$workTemp0.shouldnum_t}--/--{$workTemp0.factnum_t}--
																		</div>
																	</td>
																</tr>																
																<tr class="odd">
																...
																<tr class="odd">
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp0.gbshouldnum_t}--
																		实在：--{$workTemp0.gbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp0.gbholiday_t}--
																		外出：--{$workTemp0.gbout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp0.sgshouldnum_t}--
																		实在：--{$workTemp0.sgfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp0.sgholiday_t}--
																		外出：--{$workTemp0.sgout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp0.ywbshouldnum_t}--
																		实在：--{$workTemp0.ywbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp0.ywbholiday_t}--
																		外出：--{$workTemp0.ywbout_t}--
																		</div>
																	</td>
																</tr>
															</table>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_t" id="remark_t" rows="5" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp0.remark_t}--</textarea>
														</td>
													</tr>
														...
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																...
																<tr class="odd">
																	...
																	<td style="text-align: center;">
																		<div>
                                                                     --{$workTemp1.shouldnum_t}--/--{$workTemp1.factnum_t}--
																		</div>
																	</td>
																</tr>								
																<tr class="odd">
																...
																<tr class="odd">
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp1.gbshouldnum_t}--
																		实在：--{$workTemp1.gbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp1.gbholiday_t}--
																		外出：--{$workTemp1.gbout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp1.sgshouldnum_t}--
																		实在：--{$workTemp1.sgfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp1.sgholiday_t}--
																		外出：--{$workTemp1.sgout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp1.ywbshouldnum_t}--
																		实在：--{$workTemp1.ywbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp1.ywbholiday_t}--
																		外出：--{$workTemp1.ywbout_t}--
																		</div>
																	</td>
																</tr>
															</table>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_1" id="remark_1" rows="5" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp1.remark_t}--</textarea>
														</td>
													</tr>
														...
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																...
																<tr class="odd">
																	...
																	<td style="text-align: center;">
																		<div>
                                                                     --{$workTemp2.shouldnum_t}--/--{$workTemp2.factnum_t}--
																		</div>
																	</td>
																</tr>												
																<tr class="odd">
																...
																<tr class="odd">
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp2.gbshouldnum_t}--
																		实在：--{$workTemp2.gbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp2.gbholiday_t}--
																		外出：--{$workTemp2.gbout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp2.sgshouldnum_t}--
																		实在：--{$workTemp2.sgfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp2.sgholiday_t}--
																		外出：--{$workTemp2.sgout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp2.ywbshouldnum_t}--
																		实在：--{$workTemp2.ywbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp2.ywbholiday_t}--
																		外出：--{$workTemp2.ywbout_t}--
																		</div>
																	</td>
																</tr>
															</table>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_2" id="remark_2" rows="5" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp2.remark_t}--</textarea>
														</td>
													</tr>
														...
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																...
																<tr class="odd">
																	...
																	<td style="text-align: center;">
																		<div>
                                                                     --{$workTemp3.shouldnum_t}--/--{$workTemp3.factnum_t}--
																		</div>
																	</td>
																</tr>
																<tr class="odd">
																...
																<tr class="odd">
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp3.gbshouldnum_t}--
																		实在：--{$workTemp3.gbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp3.gbholiday_t}--
																		外出：--{$workTemp3.gbout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp3.sgshouldnum_t}--
																		实在：--{$workTemp3.sgfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp3.sgholiday_t}--
																		外出：--{$workTemp3.sgout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp3.ywbshouldnum_t}--
																		实在：--{$workTemp3.ywbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp3.ywbholiday_t}--
																		外出：--{$workTemp3.ywbout_t}--
																		</div>
																	</td>
																</tr>
															</table>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_3" id="remark_3" rows="5" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp3.remark_t}--</textarea>
														</td>
													</tr>
														...
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																...
																<tr class="odd">
																	...
																	<td style="text-align: center;">
																		<div>
                                                                     --{$workTemp4.shouldnum_t}--/--{$workTemp4.factnum_t}--
																		</div>
																	</td>
																</tr>
																<tr class="odd">
																...
																<tr class="odd">
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp4.gbshouldnum_t}--
																		实在：--{$workTemp4.gbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp4.gbholiday_t}--
																		外出：--{$workTemp4.gbout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp4.sgshouldnum_t}--
																		实在：--{$workTemp4.sgfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp4.sgholiday_t}--
																		外出：--{$workTemp4.sgout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp4.ywbshouldnum_t}--
																		实在：--{$workTemp4.ywbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp4.ywbholiday_t}--
																		外出：--{$workTemp4.ywbout_t}--
																		</div>
																	</td>
																</tr>
															</table>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_4" id="remark_4" rows="5" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp4.remark_t}--</textarea>
														</td>
													</tr>
														...
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																...
																<tr class="odd">
																	...
																	<td style="text-align: center;">
																		<div>
                                                                     --{$workTemp5.shouldnum_t}--/--{$workTemp5.factnum_t}--
																		</div>
																	</td>
																</tr>
																<tr class="odd">
																...
																<tr class="odd">
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp5.gbshouldnum_t}--
																		实在：--{$workTemp5.gbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp5.gbholiday_t}--
																		外出：--{$workTemp5.gbout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp5.sgshouldnum_t}--
																		实在：--{$workTemp5.sgfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp5.sgholiday_t}--
																		外出：--{$workTemp5.sgout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp5.ywbshouldnum_t}--
																		实在：--{$workTemp5.ywbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp5.ywbholiday_t}--
																		外出：--{$workTemp5.ywbout_t}--
																		</div>
																	</td>
																</tr>
															</table>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_5" id="remark_5" rows="5" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp5.remark_t}--</textarea>
														</td>
													</tr>
													<tr class="odd">
														...
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																...
																<tr class="odd">
																	...
																	<td style="text-align: center;">
																		<div>
                                                                     --{$workTemp6.shouldnum_t}--/--{$workTemp6.factnum_t}--
																		</div>
																	</td>
																</tr>
																<tr class="odd">
																...
																<tr class="odd">
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp6.gbshouldnum_t}--
																		实在：--{$workTemp6.gbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp6.gbholiday_t}--
																		外出：--{$workTemp6.gbout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp6.sgshouldnum_t}--
																		实在：--{$workTemp6.sgfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp6.sgholiday_t}--
																		外出：--{$workTemp6.sgout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp6.ywbshouldnum_t}--
																		实在：--{$workTemp6.ywbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp6.ywbholiday_t}--
																		外出：--{$workTemp6.ywbout_t}--
																		</div>
																	</td>
																</tr>
															</table>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_jql" id="remark_jql" rows="5" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp6.remark_t}--</textarea>
														</td>
													</tr>
													<tr class="odd">
														...
														<td style="background-color: #f2f2f2;" colspan="2">
															<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
																...
																<tr class="odd">
																	...
																	<td style="text-align: center;">
																		<div>
                                                                     --{$workTemp7.shouldnum_t}--/--{$workTemp7.factnum_t}--
																		</div>
																	</td>
																</tr>
																<tr class="odd">
																...
																<tr class="odd">
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp7.gbshouldnum_t}--
																		实在：--{$workTemp7.gbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp7.gbholiday_t}--
																		外出：--{$workTemp7.gbout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp7.sgshouldnum_t}--
																		实在：--{$workTemp7.sgfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp7.sgholiday_t}--
																		外出：--{$workTemp7.sgout_t}--
																		</div>
																	</td>
																	<td style="text-align: center;">
																		<div>
																		应在：--{$workTemp7.ywbshouldnum_t}--
																		实在：--{$workTemp7.ywbfactnum_t}--
																		</div>
																		<div>
																		休假：--{$workTemp7.ywbholiday_t}--
																		外出：--{$workTemp7.ywbout_t}--
																		</div>
																	</td>
																</tr>
															</table>
													...
													<tr class="odd">
														<td style="background-color: #f2f2f2;" colspan="2">
															<textarea name="remark_jdd" id="remark_jdd" rows="5" class="input-block-level" placeholder="无" readonly="readonly">--{$workTemp7.remark_t}--</textarea>
														</td>
													</tr>
													<tr class="odd">
										...
										--{if $showupdatedelete == "1" && $workTemp.tmp_inputtime != 0}--
										<div class="form-actions offset8">
