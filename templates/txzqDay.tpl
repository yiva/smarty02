							...
							<div class="box-content nopadding">
								<form action="--{$action}--" method="post" class='form-horizontal form-bordered'>
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="machinelinework" id="machinelinework" rows="5" class="input-block-level" placeholder="无" disabled="disabled">--{$txzqTemp.machinelinework}--</textarea>
										</div>
									</div>
									<!-- 
									<div class="control-group">
									...
									<div class="control-group">
										...
										<div class="controls">
											<textarea name="inforealize" id="inforealize" rows="5" class="input-block-level" placeholder="无" disabled="disabled">--{$txzqTemp.inforealize}--</textarea>
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">连队整修巡线情况</label>
										<div class="controls">
											<textarea name="repairlink" id="repairlink" rows="5" class="input-block-level" placeholder="无" disabled="disabled">--{$txzqTemp.repairlink}--</textarea>
										</div>
									</div>
									<div class="control-group">
										<label for="textarea" class="control-label">首长机关下连情况</label>
										<div class="controls">
											<textarea name="gbgbinfo" id="gbgbinfo" rows="5" class="input-block-level" placeholder="无" disabled="disabled">--{$txzqTemp.gbgbinfo}--</textarea>
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">大项活动及训练情况</label>
										<div class="controls">
											<textarea name="traininfo" id="traininfo" rows="5" class="input-block-level" placeholder="无" disabled="disabled">--{$txzqTemp.traininfo}--</textarea>
										</div>
									</div>
									<!-- 
									<div class="control-group">
										...
										<div class="dataTables_scroll">
												...
												<tbody>
														<tr class="odd">
															...
															<td style="background-color: #f2f2f2;border-color:#a3a3a3;"><p>--{$txzq.machinelinework}--</p></td>
														</tr>
														<!-- 
														<tr class="odd">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						<div class="box box-bordered">
							<div class="box-title">
								<h3><i class="icon-th-list"></i>--{$unit}--</h3>
								<div class=" actions"><h3>--{$date}--</h3></div>
							</div>
							<div class="box-content nopadding">
								<form action="--{$action}--" method="post" class='form-horizontal form-bordered'>
									<div class="control-group">
										<label for="textfield" class="control-label">战备保障情况(原机线电和局域网运行情况)</label>
										<div class="controls">
											<textarea name="machinelinework" id="machinelinework" rows="2" class="input-block-level" placeholder="无" disabled="disabled">--{$txzqTemp.machinelinework}--</textarea>
										</div>
									</div>
									<!-- 
									<div class="control-group">
									...
									<div class="control-group">
										<label for="textarea" class="control-label">上级指示通知落实情况</label>
										<div class="controls">
											<textarea name="inforealize" id="inforealize" rows="5" class="input-block-level" placeholder="上级指示通知落实情况" disabled="disabled">--{$txzqTemp.inforealize}--</textarea>
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">连队整修巡线情况</label>
										<div class="controls">
											<textarea name="repairlink" id="repairlink" rows="5" class="input-block-level" placeholder="连队整修巡线情况" disabled="disabled">--{$txzqTemp.repairlink}--</textarea>
										</div>
									</div>
									<div class="control-group">
										<label for="textarea" class="control-label">首长机关下连情况</label>
										<div class="controls">
											<textarea name="gbgbinfo" id="gbgbinfo" rows="5" class="input-block-level" placeholder="首长机关下连情况" disabled="disabled">--{$txzqTemp.gbgbinfo}--</textarea>
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">大项活动及训练情况</label>
										<div class="controls">
											<textarea name="traininfo" id="traininfo" rows="5" class="input-block-level" placeholder="训练情况" disabled="disabled">--{$txzqTemp.traininfo}--</textarea>
										</div>
									</div>
									<!-- 
									<div class="control-group">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						<div class="box box-bordered">
							...
							<div class="box-content nopadding">
								<form action="--{$action}--" method="post" class='form-horizontal form-column form-bordered'>
										<!-- -->
										<div class="control-group">
											<table class="table table-hover table-nomargin table-bordered dataTable-scroll-y">
												<tr >
													<td width="20%" style="text-align:center;"> <strong><font size="4">值班首长</font></strong></td>
													<td width="30%" style="text-align:center;">--{$txzqTemp.dutyhead}--</td>
													<td width="20%" style="text-align:center;"><strong><font size="4">值班员</font></strong></td>
													<td width="30%" style="text-align:center;">--{$txzqTemp.dutyer}--</td>
												</tr>
											</table>
										</div>
									<!--  
									...
									<div class="control-group">
										<label for="textfield" class="control-label">战备保障情况(原机线电和局域网运行情况)</label>
										<div class="controls">
											<textarea name="machinelinework" id="machinelinework" rows="1" class="input-block-level" placeholder="无" readonly="readonly">--{$txzqTemp.machinelinework}--</textarea>
										</div>
									</div>
									<!-- 
									<div class="control-group">
										<label for="textfield" class="control-label">局域网运行情况</label>
										<div class="controls">
											<textarea name="lanrun" id="lanrun" rows="1" class="input-block-level" placeholder="无"  readonly="readonly">--{$txzqTemp.lanrun}--</textarea>
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">每周二汇报各营线路巡检率低于95%的说明情况</label>
										<div class="controls">
											<textarea name="lowercase" id="lowercase" rows="1" class="input-block-level" placeholder="无"  readonly="readonly">--{$txzqTemp.lowercase}--</textarea>
										</div>
									</div> -->
									<div class="control-group">
										<label for="textarea" class="control-label">上级指示通知落实情况</label>
										<div class="controls">
											<textarea name="inforealize" id="inforealize" rows="1" class="input-block-level" placeholder="无"  readonly="readonly">--{$txzqTemp.inforealize}--</textarea>
										</div>
									</div>
									<div class="control-group">
										<label for="textfield" class="control-label">连队整修巡线情况</label>
									...
									<div class="control-group">
										<label for="textarea" class="control-label">台站值班抽查情况<br /><a href="GbgbController.php?flag=gbgb_Show&date=--{$date}--" target="_blank">及干部跟班情况</a></label>
										<div class="controls">
											<textarea name="dutycheck" id="dutycheck" rows="2" class="input-block-level" placeholder="无" readonly="readonly">--{$txzqTemp.dutycheck}--</textarea>
										</div>
									</div> 
