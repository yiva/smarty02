		...
		$(function(){
			...
			$('#yx_end').timepicker();
				...
				$("#bb").submit(function(){
					...
					if(hasChk2 && hasChk3){
						if(flagRet2 == 1 && flagRet3 == 1) return true;
					}
					if(hasChk2 && !hasChk3 && flagRet2 == 1){
						return true;
					}
					if(!hasChk2 && hasChk3 && flagRet3 == 1){
						return true;
					}
									...
									<div class="control-group">
										...
										<div class="controls">
											...
											<div>
												...
												<input type="text" name="nx_start" id="nx_start" disabled="disabled" class="input-small" value="">
												-
												<input type="text" name="nx_end" id="nx_end" disabled="disabled" class="input-small" check-time="nx_start">
											</div>
										</div>
									</div>
									<div class="control-group">
										...
										<div class="controls">
											...
											<div class="bootstrap-timepicker">
												...
												<input type="text" name="yx_start" id="yx_start" disabled="disabled"  class="input-small">
												-
												<input type="text" name="yx_end" id="yx_end" disabled="disabled"  class="input-small" check-time="yx_start">
											</div>
										</div>
									</div>
									<div class="control-group">
