<?php /* Smarty version 2.6.18, created on 2014-11-11 09:46:15
         compiled from left.tpl */ ?>
<?php if ($this->_tpl_vars['member']['role'] == 9): ?>
			<div class="subnav">
...
<?php elseif ($this->_tpl_vars['member']['role'] == 5): ?>		
			<div class="subnav">
				<div class="subnav-title">
...
<?php elseif ($this->_tpl_vars['member']['role'] == 1): ?>	<!-- 团行政 -->
			<div class="subnav">
				<div class="subnav-title">
					<span>团行政值班员</span>
				</div>
...
<?php elseif ($this->_tpl_vars['member']['role'] == 2): ?>	<!-- 团通信 -->
<div class="subnav">
				<div class="subnav-title">
...
<?php elseif ($this->_tpl_vars['member']['role'] == 6): ?>	<!-- 1团警勤连 -->
			<div class="subnav">
				<div class="subnav-title">
...
<?php elseif ($this->_tpl_vars['member']['role'] == 7): ?>	<!-- 1团教导队 -->
			<div class="subnav">
				<div class="subnav-title">
...
<?php elseif ($this->_tpl_vars['member']['role'] == 99): ?>	<!-- 管理员 -->
			<div class="subnav">
				<div class="subnav-title">
